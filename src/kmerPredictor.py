...
def calculate_base_probabilities(kmer_probs):
    pass

def iterate_arithmetic_encoder(base_probs):
    pass
...
for kidx in range(len(kmers)):
    ...
    # Feed true next 
    predictor.feedback_next_kmer(predicted_kmer)
